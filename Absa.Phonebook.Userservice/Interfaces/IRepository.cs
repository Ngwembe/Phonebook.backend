...
namespace Absa.Phonebook.Contactservice.Interfaces
{
    public interface IRepository
    {
        ...
        IQueryable<T> All<T>(int pageNumber, int pageSize, params System.Linq.Expressions.Expression<Func<T, object>>[] includeProperties) where T : class;
        ...
        List<T> UpdateEntities<T>(List<T> entity) where T : class;
        ...
        //IQueryable<T> ExecuteViewAsync<T>() where T : class;
